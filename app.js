...
// Album.create({
//   name: "Saving Grace", artist: "Bob Dylan", image: "https://upload.wikimedia.org/wikipedia/en/thumb/f/f1/Bob_Dylan_-_The_Times_They_Are_a-Changin%27.jpg/220px-Bob_Dylan_-_The_Times_They_Are_a-Changin%27.jpg"
// }, (err, newAlbum)=>{
//   if(err){
...
User.findOne({name: "Hai"}, (err, user)=>{
  if (err){
    console.log(err);
  } else {
