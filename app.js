...
//if you want to find a user not in the terminal, use:
User.findOne({name: "Charlie"}, (err, user)=>{
  if (err){
    // console.log(err);
  } else {
    user.albums.push({
    ...
    user.save((err, user)=>{
      //user now refers to the newly saved data as well as previously saved data for this user
      if (err){
        console.log(err);
      }
    });
